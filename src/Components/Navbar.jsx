...
const Navbar = () => {
 ...
 ;
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-gradient-to-br from-purple-50 via-pink-50 to-purple-50 ">
      <div className="px-4 py-3 mx-auto flex items-center justify-between">
        {/* Logo + Website Name */}
        <div className="flex items-center gap-2">
          <Heart className="text-purple-500" size={28} />
          <NavLink to="/" className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent">
            Matrimony
          </NavLink>
        </div>
        ...
        <div className="hidden md:flex flex-1 justify-center">
          <div className="flex gap-8">
            <NavLink to="/" className="text-gray-700 hover:text-purple-500 transition">
              Home
            </NavLink>
            <NavLink to="/biodatas" className="text-gray-700 hover:text-purple-500 transition">
              Biodatas
            </NavLink>
            <NavLink to="/about" className="text-gray-700 hover:text-purple-500 transition">
              About Us
            </NavLink>
            ...
            {
              user?.email &&
               <NavLink to="/dashboard" className="text-gray-700 flex space-x-2 hover:text-purple-500 transition">
